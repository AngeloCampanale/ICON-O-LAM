...
!    &                               open_and_restore_namelist, close_tmpfile
  ...
  USE mo_grid_config,        ONLY:                                          &
    ...
    & config_l_ocean_limited_area         => l_ocean_limited_area,          &
...
!    INTEGER  :: funit
    ...
    LOGICAL    :: l_ocean_limited_area     ! limited area setup for ocean where forcing comes in from sides
    ...
    NAMELIST /grid_nml/ lfeedback, ifeedback_type,                 &
      &  lplane, is_plane_torus, corio_lat,                        &
      &  l_limited_area, l_ocean_limited_area,                     &
